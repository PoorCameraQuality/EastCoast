...
const article = {
  id: 'mainstreaming-kink-cost',
  title: 'The Mainstreaming of Kink Comes at a Cost',
  excerpt: 'A personal reflection on how the mainstreaming of kink culture has both helped and harmed the community, from the perspective of someone who found belonging in the underground.',
  content: `
...
<p>And those of us who've been here all along? We'll keep looking for the next place to run.</p>
  `,
  author_name: 'FetlifeUser',
  author_credentials: 'Community Member & Writer',
  author_bio: 'A long-time member of the kink community who has witnessed the evolution of BDSM culture from underground spaces to mainstream visibility.',
  category: 'Community',
  tags: ['mainstreaming', 'community', 'censorship', 'underground', 'fetlife', 'visibility', 'safety', 'ethics'],
  featured: true,
  status: 'published',
