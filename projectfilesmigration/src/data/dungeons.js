...
export const dungeons = [
  {
    ...
    "excerpt": "Baltimore Playhouse has been Charm City's premier kink destination since 1997. Its 12,000 sq ft play space—the largest of its kind in the US—hosts alcohol-free, drug-free parties with a 250-attendee cap. Maryland locals seeking a vetted, inclusive BDSM community will find a welcoming home here.",
    "description": {
  ...
  },
  {
    ...
    "excerpt": "The Nest blends creative arts and kink community in Philadelphia and the Poconos. With 4,800+ sq ft near Fishtown, this collective hosts photography, mixed media, and performing arts workshops alongside social events—a unique fusion for East Coast kinksters who value artistic expression.",
    "description": {
  ...
  },
  {
    ...
    "excerpt": "The Woodshed stands out as Orlando's members-only kink dungeon on Milner Blvd—a discreet private space for BDSM exploration. Florida visitors seeking workshops, themed parties, and well-equipped play areas will find a judgment-free environment here.",
    "description": {
  ...
  },
  {
    ...
    "excerpt": "OhioSMART has been Cleveland's longest-running BDSM organization since 1995. Beyond its private dungeon, the group hosts munches, educational workshops, and outdoor activities—a solid choice for Ohio and Great Lakes kinksters seeking a vetted, inclusive community.",
    "description": {
