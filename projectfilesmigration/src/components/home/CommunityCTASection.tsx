  ...
  return (
    <section className="section-padding bg-black relative overflow-hidden" aria-labelledby="community-cta-title">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-5xl mx-auto rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 md:p-12 shadow-dark">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            <div className="md:col-span-7">
              <h2 id="community-cta-title" className="text-3xl md:text-4xl font-serif font-bold text-white mb-4">
            ...
            <div className="md:col-span-5 flex flex-col gap-3">
              <a
                ...
                className="btn-primary discord-glow text-center"
                aria-label="Join our Discord community (opens in a new tab)"
              >
                Join Community (Discord)
              </a>
              <Link href="/contact" className="btn-outline text-center" aria-label="Contact us">
                {CONTACT_US_LABEL}
              </Link>
