    ...
    extend: {
      colors: {
        ...
        sf: {
          ...
          card: 'var(--sf-card)',
          panel: 'var(--sf-panel)',
          strong: 'var(--sf-text-strong)',
          body: 'var(--sf-text-body)',
          muted: 'var(--sf-text-muted)',
          violet: 'rgb(139 92 246 / <alpha-value>)',
          blue: 'rgb(56 189 248 / <alpha-value>)',
          warm: 'rgb(244 184 96 / <alpha-value>)',
          rose: 'rgb(230 99 142 / <alpha-value>)',
          fresh: 'rgb(125 211 168 / <alpha-value>)',
        },
      },
      fontFamily: {
