  ...
  const getColorScheme = () => {
    ...
    if (event.slug === 'primal-arts-festival') {
      ...
      return {
        ...
        tertiary: 'from-indigo-500 to-primary-500',
        accent: 'from-primary-500 via-purple-500 to-indigo-500',
        hover: 'hover:text-primary-400',
        buttonHover: 'hover:from-primary-600 hover:via-purple-600 hover:to-indigo-600'
      }
    }
      ...
      <section className="relative bg-gradient-to-br from-black via-gray-900 to-black">
        ...
        <div className="absolute inset-0 opacity-20 motion-reduce:opacity-0 pointer-events-none" aria-hidden>
          {event.slug === 'primal-arts-festival' ? (
            ...
            <>
              <div className="absolute top-4 left-4 w-16 h-16 bg-primary-500 rounded-full blur-2xl animate-pulse motion-reduce:animate-none"></div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-700 rounded-2xl p-4 sm:p-6">
                  <h2 className="text-lg sm:text-xl font-serif font-bold text-white mb-3 flex items-center gap-3">
                    <div className="w-8 h-8 shrink-0 bg-gradient-to-r from-purple-500 to-primary-500 rounded-lg flex items-center justify-center" aria-hidden>
                  ...
                  <Link 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="group inline-flex min-h-touch items-center justify-center bg-gradient-to-r from-purple-500 to-primary-500 text-white font-bold py-2 px-4 rounded-lg hover:from-purple-600 hover:to-primary-600 transition-colors duration-300 shadow-lg md:hover:scale-105 motion-reduce:md:hover:scale-100 text-sm"
                  >
                    <span className="flex items-center gap-2">
                      Join Discord
