...
export const metadata: Metadata = {
  ...
  description: 'Find kink events, BDSM dungeons, and fetish community spaces in every East Coast state. Browse by location to discover local events and venues near you.',
  keywords: [
