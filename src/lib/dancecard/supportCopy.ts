...
export const supportCopy = {
  ...
  mapsNotReady: 'Venue maps are not set up for this event yet. Finish setup in Settings, or contact support.',
  floorPlansNotReady: 'Floor plans are not set up yet. Upload a map under Settings → Rooms & maps.',
