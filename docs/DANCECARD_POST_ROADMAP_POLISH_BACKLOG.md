...
| 2026-05-18 | Platform pushed to GitHub `931bc94` (migrations **007–040**, dead-code cleanup). Post-deploy: prod SQL apply, `dancecard:smoke:prod`, RLS/CI/observability items in §1 remain open. See [PROJECT_STATUS.md](./PROJECT_STATUS.md). |
